...
public:
	///Non copyable object
	Ogre_glTF_geometryBuffer_base(const Ogre_glTF_geometryBuffer_base&) = delete;

	///Non copyable object
	Ogre_glTF_geometryBuffer_base& operator=(const Ogre_glTF_geometryBuffer_base&) = delete;

	///Default move constructor
	Ogre_glTF_geometryBuffer_base(Ogre_glTF_geometryBuffer_base&&) = default;

	///Default move-assign operator
	Ogre_glTF_geometryBuffer_base& operator=(Ogre_glTF_geometryBuffer_base&&) = default;

	///Default constructor
	Ogre_glTF_geometryBuffer_base() = default;
...
public:
	...
	Ogre_glTF_geometryBuffer& operator=(Ogre_glTF_geometryBuffer&& other) noexcept
	{
		buffer		 = other.buffer;
